...
const COPY = {
  hi: {
    ...
    connector: 'जो भी फ़ोटो दिखाते हैं, वो यहाँ अपने आप जुड़ जाता है',
    gyaanTitle: 'आज की पैसे की बात', gyaanSub: 'रोज़ एक 30-सेकंड की पैसे की सीख',
    gyaanStreak: (n) => `${n}-दिन`,
    ...
    placeholder: 'कुछ पूछिए या फ़ोटो दिखाइए…',
    locale: 'hi-IN',
  },
  en: {
    ...
    connector: 'Every photo you show adds here automatically',
    gyaanTitle: 'Aaj Ki Paisa Ki Baat', gyaanSub: 'One 30-second money insight, every day',
    gyaanStreak: (n) => `${n}-day`,
    hisaabTitle: 'Your Hisaab', tileIn: 'In', tileOut: 'Out', tileSaved: 'Saved',
    hisaabSub: (m) => `Built automatically from your photos · ${m}`,
    hisaabEmpty: 'Show your first photo — your hisaab builds here →',
    trust: "We'll never ask for your OTP, PIN, or money.",
    placeholder: 'Ask or show a photo…',
    locale: 'en-IN',
  },
};
